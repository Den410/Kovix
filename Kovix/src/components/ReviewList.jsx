  ...
  return (
    <div>
      {reviews.map((review) => {
        ...
        const likeVariant =
          review.currentUserVote === 1 ? 'success' : 'outline-secondary';
        const dislikeVariant =
            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-start mb-2">
                <div className="d-flex align-items-center">
                  <Link to={profileUrl} className="me-2">
                    <div
                    ...
                    >
                      {review.userAvatar ? (
                        <img
                          src={`${API_BASE_URL}${review.userAvatar}`}
                          alt="Avatar"
                          style={{
                            width: '100%',
                            height: '100%',
              ...
              {isEditing ? (
                <div className="mt-3 p-3 bg-light rounded">
                  <Form.Group className="mb-3">
                    <Form.Label>
                      Змінити оцінку:{' '}
                      <strong>{editForm.rating}/10</strong>
                    </Form.Label>
                    <Form.Range
                      min="1"
                      max="10"
